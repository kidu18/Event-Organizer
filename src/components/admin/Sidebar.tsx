...
const navItems = [
    ...
    { name: "Bookings", icon: Ticket, href: "/dashboard/bookings" },
        ...
        <aside className="fixed left-0 top-0 h-screen w-64 bg-[#0f172a] border-r border-white/5 flex flex-col z-50">
            ...
            <div className="p-4 mt-auto space-y-4">
                ...
                <div className="pt-4 border-t border-white/5 space-y-1">
                    <Link href="/dashboard/settings" className="flex items-center gap-3 px-4 py-2 text-xs font-medium text-slate-500 hover:text-slate-300 transition-colors">
                        <Settings className="w-4 h-4" />
                        Settings
                    </Link>
                    <Link href="/dashboard/help" className="flex items-center gap-3 px-4 py-2 text-xs font-medium text-slate-500 hover:text-slate-300 transition-colors">
